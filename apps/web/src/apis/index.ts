...
export const uploadUrl = import.meta.env.DEV ? 'http://192.168.1.6:9000' : 'http://matinal.de5.net'
export const socketUrl = import.meta.env.DEV ? 'http://localhost:3000' : 'http://matinal.de5.net'
