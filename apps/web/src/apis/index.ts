...
export const uploadUrl = import.meta.env.DEV ? 'http://192.168.1.6:9000' : 'http://139.159.186.85'
export const socketUrl = import.meta.env.DEV ? 'http://localhost:3000' : 'http://139.159.186.85'
